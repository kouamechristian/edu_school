...
class Module1Fixtures extends Fixture
{
    ...
    private function createSchoolYears(ObjectManager $manager, array $schools): void
    {
        ...
        $this->createPeriods($manager, $year2024, $schools);
    }

    private function createPeriods(ObjectManager $manager, SchoolYear $schoolYear, array $schools): void
    {
    ...
    {
        // $schools : [0]=maternelle, [1]=primaire, [2]=collège, [3]=lycée, [4]=université
        $schoolsByType = [];
        foreach ($schools as $school) {
            $schoolsByType[$school->getType()] = $school;
        }

        $levels = [
            // Maternelle
            ['name' => 'Petite Section (PS)', 'type' => 'maternelle', 'order' => 1, 'description' => 'Première année de maternelle, 3 ans'],
            ['name' => 'Moyenne Section (MS)', 'type' => 'maternelle', 'order' => 2, 'description' => 'Deuxième année de maternelle, 4 ans'],
            ['name' => 'Grande Section (GS)', 'type' => 'maternelle', 'order' => 3, 'description' => 'Dernière année de maternelle, 5 ans'],

            // Primaire
            ['name' => 'CP (Cours Préparatoire)', 'type' => 'primaire', 'order' => 4, 'description' => 'Apprentissage de la lecture et de l\'écriture'],
            ['name' => 'CE1 (Cours Élémentaire 1)', 'type' => 'primaire', 'order' => 5, 'description' => 'Consolidation des apprentissages fondamentaux'],
            ['name' => 'CE2 (Cours Élémentaire 2)', 'type' => 'primaire', 'order' => 6, 'description' => 'Approfondissement des connaissances'],
            ['name' => 'CM1 (Cours Moyen 1)', 'type' => 'primaire', 'order' => 7, 'description' => 'Préparation au CM2'],
            ['name' => 'CM2 (Cours Moyen 2)', 'type' => 'primaire', 'order' => 8, 'description' => 'Dernière année de primaire'],

            // Collège
            ['name' => '6ème', 'type' => 'college', 'order' => 9, 'description' => 'Première année de collège, cycle 3'],
            ['name' => '5ème', 'type' => 'college', 'order' => 10, 'description' => 'Deuxième année de collège, cycle 4'],
            ['name' => '4ème', 'type' => 'college', 'order' => 11, 'description' => 'Troisième année de collège, cycle 4'],
            ['name' => '3ème', 'type' => 'college', 'order' => 12, 'description' => 'Dernière année de collège, préparation au brevet'],

            // Lycée
            ['name' => 'Seconde', 'type' => 'lycee', 'order' => 13, 'description' => 'Classe de détermination'],
            ['name' => 'Première', 'type' => 'lycee', 'order' => 14, 'description' => 'Première année du cycle terminal'],
            ['name' => 'Terminale', 'type' => 'lycee', 'order' => 15, 'description' => 'Année du baccalauréat'],

            // Université
            ['name' => 'Licence 1', 'type' => 'universite', 'order' => 16, 'description' => 'Première année de licence'],
            ['name' => 'Licence 2', 'type' => 'universite', 'order' => 17, 'description' => 'Deuxième année de licence'],
            ['name' => 'Licence 3', 'type' => 'universite', 'order' => 18, 'description' => 'Troisième année de licence'],
            ['name' => 'Master 1', 'type' => 'universite', 'order' => 19, 'description' => 'Première année de master'],
            ['name' => 'Master 2', 'type' => 'universite', 'order' => 20, 'description' => 'Deuxième année de master'],
        ];
        ...
        foreach ($levels as $levelData) {
            ...
            $level->setName($levelData['name'])
                ...
                ->setSchool($schoolsByType[$levelData['type']] ?? null)
                ->setIsActive(true);
